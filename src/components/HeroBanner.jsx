                ...
                + mobileBanner +  " 830w " } />
                    ...
                    <div className="carousel-caption">
                        ...
                        <p className="pb-2">Explore our handcrafted collection, trusted by customers across the globe. Every product is
                            ...
                            on <a href="https://www.indusmela.com" target="_blank" rel="noreferrer"  className="hero-banner-link">Indusmela.com</a>,<a href="https://www.indusmela.com" target="_blank" rel="noreferrer"  className="hero-banner-link">Indusmela.in</a> and <a href="https://www.amazon.in/stores/StonKraft/page/B4E8B06D-B977-4B7A-BCC6-EC923DB769E1" target="_blank" rel="noreferrer"  className="hero-banner-link">Amazon</a> ensuring premium quality, fair pricing, and reliable delivery. Our mission is to bring the warmth of Indian artistry into homes worldwide.</p>

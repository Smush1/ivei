  ...
  <div className="bulk-contact-form--main-container container-fluid" id="bulk-buy">
    <div className="bulk-contact-inner-container ">
      ...
      <div className="row justify-content-center">
        <div className="col-lg-5 text-btn-container text-center col-md-12">
          <h3 className="bulk-left-heading">Customized Corporate Gifts & Business Gifting Solutions with<p className="bulk-left-custom-heading">IVEI</p></h3>
          ...
          <a href="https://indusmela.in/pages/corporate-gifts" className="btn btn-primary view-all-btn py-3 btn-knw" aria-label='View Products' >KNOW MORE</a>
        </div>
      </div>
      </div>        
    </div>
